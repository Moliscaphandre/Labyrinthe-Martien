...
Game::Game() : _level(0), _lifes(3), _coins(0), _keys(0) {
    ...
    this->_text.setFont(Entity::_font);
    this->_text.setCharacterSize(SIZE);
    this->_text.setPosition(SIZE, HEIGHT-SIZE*2);
...
void Game::run() {
    ...
    while (this->_window.isOpen()) {
        ...
        if (this->_level >= LEVELS) {
            ...
            this->_infos.setString("               Niveau: " + std::to_string(this->_level+1) + " / " + std::to_string(LEVELS) + "                       " + std::to_string(this->_lifes)
...
void Game::changeLevel(unsigned int index) {
    ...
    switch (index) {
        case 0: {
            this->_text.setString("Bonjour je suis Marty, pourrais tu m'aider à retrouver ma famille ?");
            break;
        }
        case 1: {
            this->_text.setString("Super, je vais faire de mon mieux !");
            break;
        }
        case 2: {
        ...
        case 4: {
            this->_text.setString("J'y suis presque...");
            break;
        }
        case 5: {
            this->_text.setString("");
        ...
        case 6: {
            this->_text.setString("Mes frères !!!");
            break;
        }
        default: {
            this->_text.setString("");
